...
mj__m_BBS_Init:
 ...
 # a1: 135(1): VarAssg 134 *sz :int
 move $a1, $a0
 # a0: 136(0): This :BBS
 move $a0, $v0
 # a0: 137(0): MemberAssg 136 135 *size :int
 sw $a1, 8($a0)
 move $a0, $a1
 # a0: 138(0): This :BBS
 move $a0, $v0
 # a1: 139(1): NewIntArray 135 :int[]
 sw $v0, -4($fp)
 sw $v1, -8($fp)
 sw $a0, -12($fp)
 sw $a2, -16($fp)
 ...
 # a0: 141(0): This :BBS
 move $a0, $v0
 # a2: 142(2): Member 141 *number :int[]
 lw $a2, 4($a0)
 # a1: 143(1): Int *0 :int
 li $a1, 0
 # a0: 144(0): Int *20 :int
 li $a0, 20
 # a0: 145(0): IndexAssg 142 144 *143(1): Int *0 :int :int
 mul $v1, $a1, 4
 add $v1, $v1, 4
 add $v1, $v1, $a2
 sw $a0, ($v1)
 ...
 # a2: 154(2): Int *12 :int
 li $a2, 12
 # a0: 155(0): IndexAssg 152 154 *153(1): Int *2 :int :int
 mul $v1, $a1, 4
 add $v1, $v1, 4
 add $v1, $v1, $a0
 sw $a2, ($v1)
 ...
 # a0: 169(0): Int *11 :int
 li $a0, 11
 # a0: 170(0): IndexAssg 167 169 *168(1): Int *5 :int :int
 mul $v1, $a1, 4
 add $v1, $v1, 4
 add $v1, $v1, $a2
 sw $a0, ($v1)
 ...
 # a2: 179(2): Int *9 :int
 li $a2, 9
 # a0: 180(0): IndexAssg 177 179 *178(1): Int *7 :int :int
 mul $v1, $a1, 4
 add $v1, $v1, 4
 add $v1, $v1, $a0
 sw $a2, ($v1)
