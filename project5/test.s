...
mj__m_Fac_ComputeFac:
 ...
 slt $a0, $a1, $a0 # a0: 10(0): NBranch 9 *lif_295964671_else :void
 beq $a0, $zero, .lif_295964671_else
 # a0: 11(0): Int *1 :int
 li $a0, 1
 # a1: 12(1): VarAssg 11 *num_aux :int
 move $a1, $a0
 # a0: 13(0): Goto *lif_295964671_done :void
 j .lif_295964671_done
 # a0: 14(0): Label *lif_295964671_else :void
 .lif_295964671_else:
 # a2: 15(2): This :Fac
 move $a2, $v0
 # a0: 16(0): Int *1 :int
 ...
 move $a1, $a0
 # a0: 22(0): Label *lif_295964671_done :void
 .lif_295964671_done:
